...
class EarlyStopping:
    ...
    def __init__(self, patience=7, verbose=False, delta=0, path='Deep10checkpointv2.pt', trace_func=print):
        """
        Args:
...
def train_model(mod,num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        if early_stopping.early_stop:
            ...
            break
    model.load_state_dict(torch.load('Deep10checkpointv2.pt'))
    end = time()
...
metricdf.to_csv('DeeperMetrics10Ver4.csv')
