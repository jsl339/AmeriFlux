...
class EarlyStopping:
    ...
    def __init__(self, patience=7, verbose=False, delta=0, path='DropDeepLOGOcheckpointLE.pt', trace_func=print):
        """
        Args:
...
def train_model(mod,num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        if early_stopping.early_stop:
            ...
            break
    model.load_state_dict(torch.load('DropDeepLOGOcheckpointLE.pt'))
    end = time()
...
metricdf.to_csv('LE_swin10_filtered_logo.csv')
