...
df = df=pd.read_csv('~/data/FC50DataVer4.csv')
#df = pd.read_csv(r"C:\Users\jeffu\Documents\FC50Data.csv")
...
class EarlyStopping:
    ...
    def __init__(self, patience=7, verbose=False, delta=0, path='Deep1layerLOGOcheckpoint.pt', trace_func=print):
        """
        Args:
...
def train_model(mod,num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        if early_stopping.early_stop:
            ...
            break
    model.load_state_dict(torch.load('Deep1layerLOGOcheckpoint.pt'))
    end = time()
...
metricdf.to_csv('1LayerLOGOMetricsVer2Drop.csv')
