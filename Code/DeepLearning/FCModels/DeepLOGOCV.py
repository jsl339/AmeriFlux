...
class EarlyStopping:
    ...
    def __init__(self, patience=7, verbose=False, delta=0, path='DeepLOGOcheckpointdrop.pt', trace_func=print):
        """
        Args:
...
def train_model(mod,num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        if early_stopping.early_stop:
            ...
            break
    model.load_state_dict(torch.load('DeepLOGOcheckpointdrop.pt'))
    end = time()
...
metricdf.to_csv('DeepLOGOMetricsV3.csv')
